...
int main(int argc, char *argv[]) {
    ...
    ros::init(argc, argv, "lidar_ground_segmentation_node");
    ros::NodeHandle nh;
    ...
    std::shared_ptr<LidarGroundFilterFlow> lidar_ground_filter_flow_ptr = std::make_shared<LidarGroundFilterFlow>(nh);
    ...
    while (ros::ok()) {
        ...
        lidar_ground_filter_flow_ptr->Run();
